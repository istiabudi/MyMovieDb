...
public class SearchMovieAdapter extends RecyclerView.Adapter<SearchMovieAdapter.ViewHolder>{
    ...
    public SearchMovieAdapter(Context context, ArrayList<Movie> movies, IMovieAdapterListener movieAdapterListener) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(final Movie movie, final IMovieAdapterListener movieAdapterListener) {
