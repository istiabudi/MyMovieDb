...
public class NowPlayingTask extends AsyncTask<Void , Void , ArrayList<Movie>>{

    private INowPlayingListener nowPlayingListener;

    public NowPlayingTask(INowPlayingListener nowPlayingListener) {
    ...
    protected ArrayList<Movie> doInBackground(Void... voids) {
        ...
        try {
            ...
            String urlString = "https://api.themoviedb.org/3/movie/now_playing?api_key="
                    + DCM.TMDB_API_KEY
                    + "&language=en-US";
    ...
    protected void onPostExecute(ArrayList<Movie> movies) {
        if(this.nowPlayingListener != null)
            this.nowPlayingListener.onNowPlayingResult(movies);
    }

    public interface INowPlayingListener {
        void onNowPlayingResult(ArrayList<Movie> movies);
    }
}
